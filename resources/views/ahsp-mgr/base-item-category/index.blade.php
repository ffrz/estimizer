@extends('layout.main', [
    ...
    'nav_active' => 'ahsp-mgr_manage_base_item_categories',
])

@section('nav')
  <li class="nav-item">
    <a class="btn plus-btn btn-primary mr-2" href="{{ url("/ahsp-mgr/base-item-categories/create") }}"
                        ...
                        <tr>
                          ...
                          <td>
                            <form class="inline" method="POST" onsubmit="return confirm_delete()"
                              action="{{ url("/ahsp-mgr/base-item-categories/$category->id") }}">
                              @csrf
                              @method('DELETE')
                              <div class="btn-group">
                                <a href="{{ url("/ahsp-mgr/base-item-categories/$category->id") }}"
